            ...
            function ($stateProvider, $urlRouterProvider) {
                ...
                $stateProvider
                    ...
                    /**
                     ...
                     .state('app.bigdata', {
                         url: '/bigdata',
                         templateUrl: 'tpl/bigdata/index.html',
                                controller: 'bigdataCtrl',
                         resolve: {
                             deps: ['$ocLazyLoad',
                               function( $ocLazyLoad ){
                                 return $ocLazyLoad.load(['js/controllers/bigdata/bigdata.js']);
                               }
                             ]
                         }
                     })
                     ...
                     .state('app.resources', {
                         url: '/resources',
                         templateUrl: 'tpl/resources/index.html',
                         ...
                         resolve: {
                             deps: ['$ocLazyLoad',
                                ...
                                return $ocLazyLoad.load('toaster').then(
                                    function(){
                                        return $ocLazyLoad.load(['js/controllers/resources/resources.js']);
                                    }
                                );
                            }]
                         }
                    ...
                    .state('app.analysis', {
                        url: '/analysis',
                        templateUrl: 'tpl/analysis/index.html',
                            ...
                            deps: ['$ocLazyLoad',
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load(['toaster','ui.select']).then(
                                        function () {
                                            return $ocLazyLoad.load(['js/controllers/analysis/analysis.js']);
                                        }
                                    );
                                }]
                        }
                    ...
                    .state('app.evaluate', {
                        url: '/evaluate',
                        templateUrl: 'tpl/evaluate/index.html',
                        ...
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load(['toaster','ui.select']).then(
                                        function () {
                                            return $ocLazyLoad.load(['js/controllers/evaluate/evaluate.js']);
                                        }
                                    );
                                }]
                        }
                    ...
                    .state('app.safety', {
                        url: '/safety',
                        templateUrl: 'tpl/safety/index.html',
                        ...
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load(['toaster','ui.select']).then(
                                        function () {
                                            return $ocLazyLoad.load(['js/controllers/safety/safety.js']);
                                        }
                                    );
                                }]
                        }
